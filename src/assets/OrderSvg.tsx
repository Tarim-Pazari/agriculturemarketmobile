...
export default function OrderSvg({height = 20, width = 20}: SvgType) {
  return (
    <Svg height={height} width={width} viewBox="0 0 56 56">
      <G>
        <Polygon
          fill="#66CEDB"
          points="48,52.293 49,53.293 50,52.293 50,36 48,36 	"
        />
        <Rect x="48" y="18" fill="#66CEDB" width="2" height="16" />
        <Path
          fill="#FFFFFF"
          d="M38,8.708v40.816c1.161-0.414,2-1.514,2-2.816v-42C40,3.053,38.654,2,37,2H9
		C7.698,2,6.598,2,6.184,4H33C35.757,4,38,5.951,38,8.708z"
        />
        <Circle fill="#EE8B26" cx="19" cy="12.708" r="3" />
        <Path
          fill="#F8CF26"
          d="M36,9c0-1.657-1.343-3-3-3H5C3.343,6,2,7.343,2,9v42c0,1.657,1.343,3,3,3h28c1.657,0,3-1.343,3-3V9z
        ...
        <G>
          <Path
            d="M37,0H9C6.554,0,4.521,1.622,4.092,3.946C1.768,4.375,0,6.262,0,8.708v42C0,53.464,2.243,56,5,56h28
          ...
          />
          <Path
            d="M19,17.708c2.757,0,5-2.243,5-5s-2.243-5-5-5s-5,2.243-5,5S16.243,17.708,19,17.708z M19,9.708c1.654,0,3,1.346,3,3
          ...
          <Path
            d="M56,28.708v-8C56,19.053,54.654,18,53,18h-1v-1.292C52,16.155,51.552,16,51,16h-4c-0.552,0-1,0.155-1,0.708v36
